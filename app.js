...
const card = api => {
    ...
    api.forEach(item => {
        content += `
            <div class="col">
                <a href="page.html?name=${item.name}" class="text-decoration-none cursor-pointer" loading="lazy">
                    <article class="card shadow-sm border-0 h-100">
                        <img src="${item.flag}" class="card-img-top" alt="flag_${item.name}">
    ...
    api.forEach(item => {
        content += `
            <div class="col-12 col-lg-5 col-md-5">
                <img src="${item.flag}" class="img-fluid" alt="flag_${item.name}" loading="lazy">
            </div>
